...
### shared_buffers увеличилось с 16384 kB до 131072 kB (от 16 MB до 128 MB).

Это количество памяти, выделенной PostgreSQL для кеширования данных в памяти.
Увеличение этого параметра может повысить производительность, так как больше данных может быть закешировано в памяти,
что может привести к меньшему числу обращений к диску.
